 ...
 */
package com.api.movie.camunda.bpm.engine.rest.dto.converter;

import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.databind.JsonMappingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.api.movie.camunda.bpm.engine.rest.exception.InvalidRequestException;
...
public abstract class JacksonAwareStringToTypeConverter<T> implements StringToTypeConverter<T> {
  ...
  protected T mapToType(String value, Class<T> typeClass) {
    try {
      ...
      throw new InvalidRequestException(HttpStatus.BAD_REQUEST, e, String.format("Cannot convert value %s to java type %s",
